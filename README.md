...
| BLU_POST_REFRESH_CMD      |       | A command or function running after successfully sending lists refresh request to blocky. This can be used to trigger actions like cache flushing. |
